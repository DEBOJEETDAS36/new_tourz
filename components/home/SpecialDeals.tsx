    ...
    <section className="py-16 sm:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <span className="text-blue-600 font-bold text-lg">SPECIAL OFFERS</span>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="relative h-40 overflow-hidden">
                  ...
                  {/* Badge */}
                  <div className="absolute top-3 left-3 bg-gradient-to-r from-red-500 to-red-600 text-white px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1">
                    <Zap size={12} />
                    {deal.badge}
                  </div>
                ...
                <div className="p-5">
                  ...
                  {/* Title */}
                  <h3 className="text-lg font-bold text-gray-900 mb-1 mt-1">
                    {deal.title}
                  </h3>
                    ...
                    <div className="bg-red-50 rounded-lg p-3 mb-3 border border-red-200">
                      ...
                      <div className="grid grid-cols-3 gap-2 text-center">
                        <div className="bg-white rounded p-2">
                          <span className="font-bold text-gray-900">{String(timer.hours).padStart(2, '0')}</span>
                          <p className="text-xs text-gray-600">hrs</p>
                        </div>
                        <div className="bg-white rounded p-2">
                          <span className="font-bold text-gray-900">{String(timer.minutes).padStart(2, '0')}</span>
                          <p className="text-xs text-gray-600">min</p>
                        </div>
                        <div className="bg-white rounded p-2">
                          <span className="font-bold text-gray-900">{String(timer.seconds).padStart(2, '0')}</span>
                  ...
                  <Link
                    href={`/tours/${deal.id}`}
                    className="w-full bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold py-2 rounded-lg transition flex items-center justify-center space-x-2"
                  >
                    <span>Book Now</span>
                    <ArrowRight size={16} />
                  </Link>
        ...
        {/* Bottom CTA */}
        <div className="mt-12 bg-gradient-to-r from-red-50 to-orange-50 rounded-lg p-8 text-center border-2 border-red-200">
          ...
          <button className="bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white font-bold py-3 px-8 rounded-lg transition">
            View All Offers
          </button>
        </div>
      </div>
