...
import { leisureTours, leisureTags } from '@/lib/data/leisureTours';

export default function LeisureToursList() {
  ...
  const filteredTours = leisureTours.filter(tour => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className={`lg:col-span-1 ${showFilters ? 'block' : 'hidden'} lg:block`}>
            <div className="bg-[#1a3a52] rounded-lg p-6 border border-[#374151] sticky top-24">
              ...
              {/* Tags Filter */}
              <div>
                <h4 className="text-[#14B8A6] font-semibold mb-4 text-sm uppercase">Tour Type</h4>
          ...
          <div className="lg:col-span-3">
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    ...
                    <div className="flex flex-wrap gap-2 mb-3">
                      {tour.tags.slice(0, 2).map((tag) => (
                        <span
                          key={tag}
                          className="bg-[#14B8A6]/20 text-[#14B8A6] px-2 py-1 rounded text-xs font-semibold"
                        >
                          {tag}
                        </span>
                      ))}
            ...
            {sortedTours.length === 0 && (
              <div className="text-center py-12">
                <p className="text-[#94A3B8] text-lg">No tours found for selected filters</p>
              </div>
            )}
          </div>
        </div>
