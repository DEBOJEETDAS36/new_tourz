...
export const tourDetailsMap: { [key: string]: TourDetail } = {
  ...
  '5': {
    ...
    category: 'leisure',
    tags: ['Beach', 'Luxury', 'International', 'Honeymoon', 'Water Sports'],
    description: 'Crystal waters and world-class luxury resorts for an unforgettable tropical escape.',
    overview: 'Experience paradise in the Maldives with this luxurious 5-day tropical escape. Stay in overwater bungalows, snorkel in crystal-clear waters, enjoy spa treatments, and relax on pristine beaches. The Maldives is perfect for honeymooners, luxury travelers, and those seeking ultimate relaxation and romance.',
    highlights: [
      'Stay in luxurious overwater bungalows',
      ...
      'Romantic sunset dinners on the beach',
      'Visit local island communities',
    ],
    inclusions: [
      'Round-trip flights from India',
      '4 nights accommodation in 5-star resort',
      'All meals (breakfast, lunch, dinner)',
      'Airport transfers and speedboat',
    ...
    itinerary: [
      {
        ...
        description: 'Arrive in Male and speedboat transfer to your island resort.',
        activities: [
          'Airport arrival',
          'Speedboat to resort',
          'Resort check-in and welcome',
          'Beach relaxation',
          'Sunset at the resort',
        ],
        meals: { lunch: true, dinner: true },
        accommodation: '5-Star Resort Overwater Bungalow',
      },
      {
        day: 2,
        title: 'Snorkeling Adventure',
        description: 'Explore the underwater world of the Maldives.',
        activities: [
          'Guided snorkeling tour',
          'Fish feeding at house reef',
      ...
      {
        day: 3,
        title: 'Island Hopping & Water Sports',
        description: 'Visit local islands and enjoy water sports activities.',
        activities: [
          'Speed boat island tour',
      ...
      },
      {
        ...
        description: 'Full day of relaxation and spa treatments.',
        activities: [
    ...
    priceBreakdown: {
      'Flights (Round-trip)': 22000,
      'Resort (4 nights, 5-star)': 32000,
      'All Meals & Dining': 8000,
      'Water Sports & Activities': 4000,
      'Airport Transfers': 2000,
    },
    groupSize: {
      min: 2,
    ...
    testimonials: [
      {
        ...
        location: 'Mumbai',
        rating: 5,
        review: 'Absolutely perfect honeymoon destination! The luxury, the views, and the hospitality were all world-class.',
        avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop',
      },
      {
        name: 'Sneha Gupta',
        location: 'Bangalore',
        rating: 5,
        review: 'Living in the bungalow over water was a dream come true. Snorkeling right outside our room was amazing!',
        avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop',
      },
      {
        name: 'Rahul Desai',
        location: 'Delhi',
        rating: 4.9,
        review: 'Pure paradise! The Maldives exceeded all expectations. Worth every penny for a luxury getaway.',
        avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop',
      },
    ],
    importantNotes: [
      'No visa required for Indian citizens (30 days visa-free)',
      'Pack reef-safe sunscreen to protect coral',
      'Bring waterproof camera for underwater photography',
      'Resort islands are alcohol-free (alcohol available at resort bar)',
      'Local currency is Rufiyaa, USD widely accepted',
      'Best weather is dry season from November to April',
    ],
    cancellationPolicy: 'Free cancellation until 45 days before travel. 50% refund between 30-45 days. No refund within 30 days.',
  },
  ...
  '6': {
    ...
    galleryImages: [
      'https://images.unsplash.com/photo-1540959375944-7049f642e9d4?w=600&h=400&fit=crop',
      'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=600&h=400&fit=crop',
      'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=600&h=400&fit=crop',
      'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?w=600&h=400&fit=crop',
      'https://images.unsplash.com/photo-1521401830884-6c03c1c2ee6d?w=600&h=400&fit=crop',
      'https://images.unsplash.com/photo-1464207687429-7505649dae38?w=600&h=400&fit=crop',
    ],
    category: 'leisure',
    tags: ['Cultural', 'City', 'International', 'Adventure', 'Technology'],
    description: 'Modern culture meets ancient tradition in the vibrant capital of Japan.',
    overview: 'Experience Tokyo, where cutting-edge technology meets ancient traditions. Explore bustling markets, visit ancient temples, enjoy world-class cuisine, and experience the unique blend of old and new. Perfect for culture enthusiasts, food lovers, and adventure seekers. This 5-day tour showcases the best of Tokyo\'s vibrant energy.',
    highlights: [
      'Experience Senso-ji Temple and traditional culture',
      'Visit the famous Shibuya Crossing',
      'Explore high-tech Akihabara district',
      'Shop in fashionable Harajuku and Shinjuku',
      'Enjoy authentic Japanese cuisine',
      'Visit teamLab digital art museum',
      'Experience sumo wrestling tradition',
    ...
    exclusions: [
      ...
      'Tips and gratuities',
      'Sumo tournament tickets (if not in season)',
      'Premium restaurants',
    ],
    itinerary: [
      {
        day: 1,
        title: 'Tokyo Arrival',
        description: 'Arrive in Tokyo and explore the city.',
        activities: [
          'Airport arrival (Narita or Haneda)',
          'Transfer to hotel',
          'Hotel check-in',
          'Explore nearby district',
          'Welcome dinner at local restaurant',
        ],
        meals: { lunch: true, dinner: true },
        accommodation: '4-Star Hotel in Shibuya',
      },
      {
        day: 2,
        title: 'Traditional & Modern Tokyo',
        description: 'Experience both traditional and modern Tokyo.',
        activities: [
          ...
          'Dinner at izakaya (Japanese pub)',
        ],
        meals: { breakfast: true, lunch: true, dinner: true },
        accommodation: '4-Star Hotel in Shibuya',
      },
      {
        ...
        description: 'Explore trendy Harajuku and tech-savvy Akihabara.',
        activities: [
          'Harajuku fashion district walk',
          'Meiji Shrine visit',
          'Lunch in Harajuku',
          'Akihabara electronics shopping',
          'Anime culture exploration',
          'Dinner at themed restaurant',
        ],
        meals: { breakfast: true, lunch: true, dinner: true },
        accommodation: '4-Star Hotel in Shinjuku',
      },
      {
        day: 4,
        title: 'Culture & Gardens',
        description: 'Experience peaceful gardens and cultural sites.',
        activities: [
    ...
    priceBreakdown: {
      'Flights (Round-trip)': 18000,
      'Hotel (4 nights, 4-star)': 18000,
      'Meals & Dining': 8000,
      'JR Pass & Transport': 5000,
      'Tours & Attractions': 5000,
    },
    groupSize: {
      min: 2,
      max: 16,
    ...
    testimonials: [
      {
        ...
        location: 'Delhi',
        rating: 5,
        review: 'Tokyo is incredible! The mix of ancient temples and futuristic technology is mind-blowing. Best city tour ever!',
        avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=150&h=150&fit=crop',
      },
      {
        name: 'Pooja Sharma',
        location: 'Pune',
        rating: 4.9,
        review: 'The food alone is worth the trip! Amazing cuisine, wonderful people, and unforgettable experiences.',
        avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop',
      },
      {
        name: 'Hari Kumar',
        location: 'Chennai',
        rating: 4.8,
        review: 'Tokyo exceeded expectations. The JR pass was super convenient. Perfect blend of culture and modernity.',
        avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop',
      },
    ],
    importantNotes: [
      'Japan visa required (apply for tourist visa from Indian embassy)',
      'Japan Rail Pass (JR Pass) included - activate at airport',
      'Learn basic Japanese phrases for better experience',
      'Cash is preferred over cards in many places',
      'Spring (March-May) and Autumn (September-November) are best seasons',
      'Respect temple and shrine customs (remove shoes, no photography)',
    ],
    cancellationPolicy: 'Free cancellation until 40 days before travel. 50% refund between 20-40 days. No refund within 20 days.',
  },
};